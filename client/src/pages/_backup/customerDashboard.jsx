...
import { ShoppingCart, Package, Home, CheckCircle, AlertTriangle, Flag, User, HelpCircle } from 'lucide-react';
...
const CustomerDashboard = () => {
  ...
  const customerMenuItems = [
    ...
    { icon: <Package size={18} />, label: 'My Verifications', path: '#' },
    { icon: <ShoppingCart size={18} />, label: 'Product History', path: '#' },
    { icon: <AlertTriangle size={18} />, label: 'Safety Alerts', path: '#' },
    { icon: <Flag size={18} />, label: 'Report Fake', path: '#' },
    { icon: <User size={18} />, label: 'Profile', path: '#' },
    { icon: <HelpCircle size={18} />, label: 'Help & FAQs', path: '#' },
  ];
